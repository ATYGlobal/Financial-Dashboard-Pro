  ...
  return (
    <div className="bg-white rounded-2xl border border-[#e4e7ed] p-5 shadow-[0_1px_2px_0_rgb(0_0_0/0.04),0_0_0_1px_rgb(0_0_0/0.04)] transition-shadow duration-200 hover:shadow-[0_4px_12px_-2px_rgb(0_0_0/0.08),0_0_0_1px_rgb(0_0_0/0.04)]">
      <div className="flex items-start justify-between mb-3">
        <p className="text-xs font-medium text-[#9aa3b5] uppercase tracking-wide">
          {label}
        </p>

        {icon && (
          <div
            className={`w-7 h-7 rounded-lg ${cfg.iconBg} flex items-center justify-center`}
          >
      ...
      <p className={`text-2xl font-bold font-mono tracking-tight ${cfg.text}`}>
        {display}
      </p>
